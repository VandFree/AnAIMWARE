return {
    ...
    },
    {
        ...
        {"Auto-Shove Filter"},
        {"Filter","Set the aimbot target filter"},
        {"Mode",{"FOV", "Distance", "Set how the aimbot will prioritize targets"}},
        {"FOV","Maximum field of view the aimbot will target within"},
        {"Priority Mode","Allow ragebot to prloritize high value targets"},
        ...
        {"Witch Rage Bar","Draw witch rage bar"},
        {"Boomer Blast Radius","Draw blast radius"},
        {"Filter"},
        {"Box", {"Off", "Outlined", "Normal", "Draw 2D box around entity"}},
        {"Name","Draw entity name"},
        ...
        {"Enable","Enable the speedhack"},
        {"Amount","Speedhack amount"},
        {"Key","Key to activate speedhack"},
        ...
        {"No Fall Damage","Prevent fall damage when landing"},
        {"Steal Name","Steal other player names"},
        ...
        {"Dpi Scale Visuals", "Include visual elements to scaling."},
